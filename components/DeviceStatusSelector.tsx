...
type Props = {
  ...
  onClose: () => void;
  onSelectStatus: (status: DeviceStatus) => void;
};

export default function DeviceStatusSelector({ visible, currentStatus, onClose, onSelectStatus }: Props) {
  ...
  const handleSelect = (status: DeviceStatus) => {

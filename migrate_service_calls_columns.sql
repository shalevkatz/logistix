-- Add missing columns for service call completion tracking
...
COMMENT ON COLUMN service_calls.cannot_complete_reason IS 'Reason provided by employee when they cannot complete the service call';
...
AND column_name IN ('completed_by_employee_id', 'cannot_complete_reason', 'cannot_complete_at');
